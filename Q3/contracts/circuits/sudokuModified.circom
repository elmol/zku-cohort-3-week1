...
template sudoku() {
    ...
    for (var i=0; i<9; i++) {
        for (var j=0; j<9; j++) {
            ...
            inRange[0][i][j] = RangeProof(32);
            inRange[0][i][j].in <== puzzle[i][j];
            inRange[0][i][j].range[0] <== 0;
            inRange[0][i][j].range[1] <== 9;
            assert(inRange[0][i][j].out);
            ...
            inRange[1][i][j] = RangeProof(32);
            inRange[1][i][j].in <== puzzle[i][j];
            inRange[1][i][j].range[0] <== 0;
            inRange[1][i][j].range[1] <== 9;
            assert(inRange[1][i][j].out);
